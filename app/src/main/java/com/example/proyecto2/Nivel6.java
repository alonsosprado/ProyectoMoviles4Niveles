...
public class Nivel6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this,"Nivel 6- Multiplicaciones por 5",Toast.LENGTH_SHORT).show();
        ...
        if(score <= 6){
            ...
            for(int i = 0;i < numero.length;i++){
                ...
                if(numAleatorio_dos == i){
                    iv_Ados.setImageResource(getResources().getIdentifier(numero[5],"drawable",getPackageName()));
                }
            }
        }else{
            Intent intent = new Intent(this,Nivel7.class);
