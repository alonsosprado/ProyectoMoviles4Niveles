...
public class Nivel7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this,"Nivel 7- Multiplicaciones por 8",Toast.LENGTH_SHORT).show();
           ...
           resultado = numAleatorio_uno * 8;
            ...
            for(int i = 0;i < numero.length;i++){
                ...
                if(numAleatorio_dos == i){
                    iv_Ados.setImageResource(getResources().getIdentifier(numero[8],"drawable",getPackageName()));
                }
            }
        }else{
            Intent intent = new Intent(this,Nivel8.class);
